...
async function handleAiPass(supabase: any, lovableApiKey: string) {
  ...
  const { data: dirtyRows, error } = await supabase
    ...
    .or("normalized_water_body.like.%Site %,normalized_water_body.like.% @ %,normalized_water_body.like.%Mile%,normalized_water_body.like.%Rmi%,normalized_water_body.like.% Nr %,normalized_water_body.like.% Near %,normalized_water_body.like.% Above %,normalized_water_body.like.% Below %,normalized_water_body.like.% at %,normalized_water_body.like.% nr %,normalized_water_body.like.% near %,normalized_water_body.like.% above %,normalized_water_body.like.% below %")
    .limit(AI_BATCH_SIZE);
